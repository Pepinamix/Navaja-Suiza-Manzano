:: =========================================================================
::  NAVAJA SUIZA MANZANO - Windows Diagnostic & Management Suite
:: =========================================================================
::  Version:   2.0
::  License:   MIT
::  Repo:      https://github.com/<tu-usuario>/navaja-suiza-manzano
::
::  Menu-driven toolbox for Windows technicians: quick-access settings
::  panels, license/activation tools, driver rescue & injection, cleanup,
::  system repair (SFC/DISM/BCD), disk tools + SHA256 duplicate finder,
::  backup/cloning, networking, MMC consoles, user/security management,
::  process control, hardware reports, WinGet deployment, power control
::  and PowerShell utilities. Available in 10 languages.
::
::  REQUIREMENTS: Windows 10/11, run as Administrator.
::  DISCLAIMER: Several options are destructive or security-sensitive
::  (deleting users, resetting passwords, mirror-cloning with deletion,
::  rebuilding boot records). Read each prompt carefully. Use only on
::  equipment you own or are authorized to service.
:: =========================================================================
@echo off
...
:: Almost every branch (SFC/DISM, net user, wmic, bootrec, services) needs
:: admin rights, so we request them once up front instead of failing
:: silently deep inside a submenu.
:: -------------------------------------------------------------------------
net session >nul 2>&1
if %errorlevel% neq 0 (
...
:: -------------------------------------------------------------------------
:: ASIGNACION DE VARIABLES DE TEXTO SEGUN IDIOMA
:: -------------------------------------------------------------------------
:LANG_ES
...
set "T_CONFIRM=> ATENCION: Esta accion no se puede deshacer. Escribe Y para confirmar: "
set "T_CANCEL=[!] Operacion cancelada."
...
set "S5_6=Crear un Punto de Restauracion del Sistema (CMD/PS)"

:: Sub 6
set "S6_1=Escaneo de errores de archivo en disco (CMD)"
set "S6_2=Escaneo profundo y reparacion de sectores defectuosos (CMD)"
set "S6_3=BUSCADOR DE ARCHIVOS DUPLICADOS POR HASH SHA256 (PowerShell)"
...
set "S8_8=Ver IP Publica de Internet (PowerShell)"
...
set "S9_9=Firewall de Windows (CMD)"
set "S9_10=Programador de Tareas (CMD)"
...
set "S14_6=Suspender el equipo / Modo de Suspension (CMD)"
...
set "S15_6=Comprobar estado de cifrado BitLocker (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> WARNING: This action cannot be undone. Type Y to confirm: "
set "T_CANCEL=[!] Operation cancelled."
...
set "S5_6=Create a System Restore Point (CMD/PS)"

set "S6_1=Scan for file errors on disk (CMD)"
set "S6_2=Deep scan and repair bad sectors (CMD)"
set "S6_3=DUPLICATE FILE FINDER BY SHA256 HASH (PowerShell)"
...
set "S8_8=View Public Internet IP (PowerShell)"
...
set "S9_9=Windows Firewall (CMD)"
set "S9_10=Task Scheduler (CMD)"
...
set "S14_6=Suspend the computer / Sleep mode (CMD)"
...
set "S15_6=Check BitLocker encryption status (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> ATTENTION : Cette action est irreversible. Tapez Y pour confirmer : "
set "T_CANCEL=[!] Operation annulee."
...
set "S5_6=Creer un point de restauration systeme (CMD/PS)"
...
set "S6_3=RECHERCHE DE DOUBLONS PAR HASH SHA256 (PowerShell)"
...
set "S8_8=Afficher l'IP publique Internet (PowerShell)"
...
set "S9_9=Pare-feu Windows (CMD)"
set "S9_10=Planificateur de taches (CMD)"
...
set "S10_4=Activer le compte Administrateur nativo masque (CMD)"
...
set "S14_6=Mettre l'ordinateur en veille (CMD)"
...
set "S15_6=Verifier l'etat du chiffrement BitLocker (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> WARNUNG: Diese Aktion kann nicht rueckgaengig gemacht werden. Y zum Bestaetigen eingeben: "
set "T_CANCEL=[!] Vorgang abgebrochen."
...
set "S5_6=Systemwiederherstellungspunkt erstellen (CMD/PS)"

set "S6_1=Datentraeger auf Dateifehler scannen (CMD)"
set "S6_2=Tiefenscan und Reparatur fehlerhafter Sektoren (CMD)"
set "S6_3=DUPLIKAT-DATEI-SUCHER UEBER SHA256 HASH (PowerShell)"
...
set "S8_8=Oeffentliche Internet-IP anzeigen (PowerShell)"
...
set "S14_6=Computer in den Ruhezustand versetzen (CMD)"
...
set "S15_6=BitLocker-Verschluesselungsstatus pruefen (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> ATTENZIONE: Questa azione non puo essere annullata. Digita Y per confermare: "
set "T_CANCEL=[!] Operazione annullata."
...
set "S5_6=Crea un punto di ripristino del sistema (CMD/PS)"

set "S6_1=Scansione errori di file su disco (CMD)"
set "S6_2=Scansione profonda e riparazione settori danneggiati (CMD)"
set "S6_3=RICERCA FILE DUPLICATI TRAMITE HASH SHA256 (PowerShell)"
...
set "S8_8=Visualizza IP pubblico Internet (PowerShell)"
...
set "S9_9=Firewall di Windows (CMD)"
set "S9_10=Utilita di pianificazione (CMD)"
...
set "S14_6=Sospendi il computer (CMD)"
...
set "S15_6=Controlla stato crittografia BitLocker (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> ATENCAO: Esta acao nao pode ser desfeita. Digite Y para confirmar: "
set "T_CANCEL=[!] Operacao cancelada."
...
set "S5_6=Criar um Ponto de Restauracao do Sistema (CMD/PS)"

set "S6_1=Verificacao de erros de arquivo no disco (CMD)"
set "S6_2=Varredura profunda e reparacao de setores defeituosos (CMD)"
set "S6_3=LOCALIZADOR DE ARQUIVOS DUPLICADOS POR HASH SHA256 (PowerShell)"
...
set "S8_8=Ver IP Publico da Internet (PowerShell)"
...
set "S9_9=Firewall do Windows (CMD)"
set "S9_10=Agendador de Tarefas (CMD)"
...
set "S14_6=Suspender o computador (CMD)"
...
set "S15_6=Verificar status de criptografia BitLocker (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> 警告: この操作は元に戻せません。確認するには Y を入力してください: "
set "T_CANCEL=[!] 操作はキャンセルされました。"
...
set "S5_6=システムの復元ポイントを作成 (CMD/PS)"

set "S6_1=ディスク上のファイルエラーのスキャン (CMD)"
set "S6_2=不良セクタの詳細スキャンと修復 (CMD)"
set "S6_3=SHA256ハッシュによる重複ファイルファインダー (PowerShell)"
...
set "S8_8=インターネットのパブリックIPを表示 (PowerShell)"
...
set "S9_9=Windowsファイアウォール (CMD)"
set "S9_10=タスクスケジューラ (CMD)"
...
set "S15_6=BitLocker暗号化状態を確認 (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> 警告：此操作无法撤销。输入 Y 确认: "
set "T_CANCEL=[!] 操作已取消。"
...
set "S5_5=重置网络组件 (CMD)"
set "S5_6=创建系统还原点 (CMD/PS)"

set "S6_1=扫描磁盘上的文件错误 (CMD)"
set "S6_2=深度扫描并修复坏道 (CMD)"
set "S6_3=基于 SHA256 哈希的重复文件查找器 (PowerShell)"
...
set "S9_9=Windows 防火墙 (CMD)"
set "S9_10=任务计划程序 (CMD)"
...
set "S15_6=检查 BitLocker 加密状态 (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> VNIMANIE: Eto deystviye nelzya otmenit. Vvedite Y dlya podtverzhdeniya: "
set "T_CANCEL=[!] Operatsiya otmenena."
...
set_5_2=Remont obraza Windows online (CMD)
...
set "S5_6=Sozdat' tochku vosstanovleniya sistemy (CMD/PS)"

set "S6_1=Skanirovaniye oshibok faylov na diske (CMD)"
set "S6_2=Glubokiy skan i remont povrezhdennykh sektorov (CMD)"
set "S6_3= POISK DUBLIKATOV FAYLOV PO HASH SHA256 (PowerShell)"
...
set "S8_8=Prosmotret' publichnyy IP Internet (PowerShell)"
...
set "S9_9=Brandmauer Windows (CMD)"
set "S9_10=Planirovshchik zadaniy (CMD)"
...
set "S14_6=Perevesti kompyuter v spyashchiy rezhim (CMD)"
...
set "S15_6=Proverit' status shifrovaniya BitLocker (PowerShell)"
goto MENU_PRINCIPAL
...
set "T_CONFIRM=> Tahdheer: La yumkin al-taraju an hadha al-ijraa. Idghat Y lil-takid: "
set "T_CANCEL=[!] Tam Ilgha al-Amaliyyah."
...
set "T_SUB3=Idaarat, nuskhat ihtiyaatiyya wa haqan al- تعريفات (CMD)"
...
set "S1_6=Fath lawhat al-tahakkum al-kلاسيكية (CMD)"
...
set "S5_6=Insha' Nuqtat Istirdad lil-Nizam (CMD/PS)"

set "S6_1=Fahs akhta' al-malaffat 'ala al-qirs (CMD)"
set "S6_2=Fahs 'ameeq wa islah al-qita'aat al-talifah (CMD)"
set "S6_3=Baahith al-malaffat al-mutakarriraat bi-nizam HASH SHA256 (PowerShell)"
...
set "S8_8=Mushahadat 'Unwan IP al-'Aam lil-Internet (PowerShell)"
...
set "S9_9=Jidar Himayah Windows (CMD)"
set "S9_10=Mujadwil al-Mahaam (CMD)"

set "S10_1=I'daad jamee' hisaabaat al-mustakhdimin 'ala hadha al-jihaz (CMD)"
...
set "S14_6=I'aadat al-Jihaz ila Wadh' al-Sukoon (CMD)"
...
set "S15_6=Al-Tahaqquq min Halat Tashfeer BitLocker (PowerShell)"
goto MENU_PRINCIPAL
...
if "%sub2%"=="1" ( dism /online /cleanup-image /scanhealth & sfc /scannow & pause & goto SUB_REPARACION )
...
if "%sub2%"=="6" (
    echo. & echo Creating System Restore Point...
    powershell -NoProfile -Command "Enable-ComputerRestore -Drive 'C:\'; Checkpoint-Computer -Description 'NavajaSuizaManzano_Manual' -RestorePointType 'MODIFY_SETTINGS'"
    echo [OK] Done ^(Windows allows one automatic restore point per 24h; this forces a fresh one^).
    pause & goto SUB_REPARACION
)
...
if "%sub3%"=="5" (
    set "conf="
    set /p conf="!T_CONFIRM!"
    if /i "!conf!"=="Y" ( bootrec /fixmbr & bootrec /fixboot ) else ( echo !T_CANCEL! )
...
cls
echo =======================================================================
echo         DUPLICATE FINDER (PowerShell SHA256)
echo =======================================================================
set "scanpath="
set /p scanpath="> Path to scan (e.g. C:\Photos or F:\): "
if not defined scanpath goto SUB_DISCOS

echo.
echo   [1] Photos (*.jpg, *.png, *.webp...)
echo   [2] Videos (*.mp4, *.mkv, *.avi...)
echo   [3] All files (*.*)
set "scantype="
set /p scantype="> File type (1-3): "
...
echo $ext = switch($t) { '1' { '*.jpg','*.jpeg','*.png','*.webp','*.cr2','*.nef' } '2' { '*.mp4','*.mkv','*.avi','*.mov' } Default { '*.*' } } >> "%PSFILE%"
...
echo if (-not $files) { Write-Host "No files found." -ForegroundColor Red; exit } >> "%PSFILE%"
echo Write-Host "Total files: $($files.Count)" -ForegroundColor Yellow >> "%PSFILE%"
echo $i = 0 >> "%PSFILE%"
echo $hashes = foreach ($f in $files) { >> "%PSFILE%"
echo     $i++ >> "%PSFILE%"
echo     Write-Progress -Activity 'Computing SHA256 Hash' -Status "$i de $($files.Count)" -PercentComplete (($i / $files.Count) * 100) >> "%PSFILE%"
...
echo if (-not $dups) { Write-Host "No duplicates found." -ForegroundColor Green; exit } >> "%PSFILE%"
echo $toDel = @() >> "%PSFILE%"
...
echo         Write-Host "[DELETE]: $($g.Group[$j].Path)" -ForegroundColor Red >> "%PSFILE%"
echo         $toDel += $g.Group[$j].Path >> "%PSFILE%"
echo     } >> "%PSFILE%"
echo } >> "%PSFILE%"
echo Write-Host "`nTotal duplicates: $($toDel.Count)" -ForegroundColor Yellow >> "%PSFILE%"
echo $ans = Read-Host 'Delete duplicates? (Type S to delete)' >> "%PSFILE%"
echo if ($ans -eq 'S' -or $ans -eq 's') { >> "%PSFILE%"
echo     $toDel ^| Remove-Item -Force -ErrorAction SilentlyContinue >> "%PSFILE%"
echo     Write-Host "Duplicates deleted." -ForegroundColor Green >> "%PSFILE%"
echo } else { Write-Host "Cancelled." -ForegroundColor Yellow } >> "%PSFILE%"
...
if "%sub6%"=="3" (
    ...
    set /p conf="!T_CONFIRM!"
    if /i "!conf!"=="Y" ( robocopy "!origen!" "!destino!" /MIR /R:1 /W:1 /MT:8 ) else ( echo !T_CANCEL! )
    pause & goto SUB_BACKUP
)
if "%sub6%"=="4" (
    set "drive="
...
if "%sub7%"=="8" (
    echo. & echo Querying public IP...
    powershell -NoProfile -Command "try { (Invoke-RestMethod -Uri 'https://api.ipify.org?format=json' -TimeoutSec 5).ip } catch { Write-Host 'Could not reach the Internet.' -ForegroundColor Red }"
    pause & goto SUB_REDES
)
...
if "%sub_mmc%"=="9" ( start firewall.cpl & goto SUB_MMC )
if "%sub_mmc%"=="10" ( start taskschd.msc & goto SUB_MMC )
...
if "%sub11%"=="6" ( rundll32.exe powrprof.dll,SetSuspendState 0,1,0 & goto SUB_ENERGIA )
...
if "%sub_ps%"=="6" (
    echo. & echo Checking BitLocker status...
    powershell -NoProfile -Command "Get-BitLockerVolume | Format-Table MountPoint,VolumeStatus,ProtectionStatus,EncryptionPercentage -AutoSize"
    pause & goto SUB_PS_UTILIDADES
)
if "%sub_ps%"=="5" (
